create function library.update_librarytoptracks(minlength int, maxlength int) returns int as $$
begin
	...
	where fh.duration between minlength and maxlength
	...
	where ft.artist_id <> ft.album_artist_id and fh.duration between minlength and maxlength;
