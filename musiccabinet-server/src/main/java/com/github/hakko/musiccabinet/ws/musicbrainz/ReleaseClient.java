 ...
 * http://musicbrainz.org/ws/2/release/?query=arid:5b11f4ce-a62d-471e-81fc-a69a8278c7da AND (primarytype:Album OR primarytype:EP OR primarytype:Single) AND NOT secondarytype:compilation AND NOT secondarytype:live AND NOT secondarytype:soundtrack AND status:official&limit=100
 * 
 * Doc: http://musicbrainz.org/doc/Indexed_Search_Syntax 
 */
public class ReleaseClient extends AbstractMusicBrainzClient {

	protected static final String PATH = "/ws/2/release/";
