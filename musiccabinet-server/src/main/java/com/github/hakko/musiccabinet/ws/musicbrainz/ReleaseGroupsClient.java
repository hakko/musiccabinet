 ...
 * http://www.musicbrainz.org/ws/2/release-group/?artist=5b11f4ce-a62d-471e-81fc-a69a8278c7da&limit=100
 */
public class ReleaseGroupsClient extends AbstractMusicBrainzClient {
	...
	protected static final String ARID = "arid:";
	...
	public String get(String artistName, String mbid, int offset) throws ApplicationException {
		...
		params.add(new BasicNameValuePair(ARTIST, ARID + mbid));
